   ...
   var $show_count      = true;
	...
	function getAJAXlink( $count, $text) {
		...
		return "<a href=\"javascript:void(0);\"
		         " . $this->anchor_class . "
					onclick=\"$.post('". $this->base_url . $count ."', ". $this->additional_param .", function(data){moveTarget();scropTopComment('#product_details_comment');
