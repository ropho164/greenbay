      ...
      <tr>
        <td valign="top">
          <div id="contentpage">            
			...
			echo form_open('admin/photos/proaddata',$attributes); 
			?>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td valign="middle"><input name="alert_product_photo_slide" type="text" id="alert_product_photo_slide" readonly style="display:none" />
                      (Tối đa 5 ảnh)&nbsp;&nbsp;<span id="slide_err" class="errorValidate"></span></td>
                  </tr>
                  <tr>
                    ...
                    if(count($list_photo) > 0){
							for($i=0;$i<count($list_photo);$i++)
							{
								...
								echo '<a href="'.base_url().'uploads/photos/'.$list_photo[$i].'" target="_blank"><img src="'.base_url().'uploads/photos/'.$list_photo[$i].'" style="width:100px;height:100px"/></a><br/><input id="slidephotoorder[]" name="slidephotoorder[]"  type="text" style="width:85px;text-align:center" value="'.($i+1).'" />';
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$('#userfile3').uploadFile({
			...
			url:"<?php echo base_url(); ?>admin/uploadify/do_upload_photos",
			fileName:"userfile",
			autoSubmit:true,
			returnType: "json",
			showPreview:false,
			...
			onSuccess:function(files,data,xhr,pd){
				if(data.file_name!='' && data.file_name!=null){
					...
					htmlText+='<a href="<?php echo base_url().'uploads/photos/'?>'+data.file_name+'" target="_blank"><img src="<?php echo base_url().'uploads/photos/'?>'+data.file_name+'" style="width:100px;height:100px"/></a><br/><input id="slidephotoorder[]" name="slidephotoorder[]"  type="text" style="width:100px;text-align:center" value="'+numPhoto+'" />';
