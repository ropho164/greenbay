  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top">
          <div id="contentpage">            
            <div id="iTitle">Điều khoản - Thêm danh mục</div><br/>
            <?php 
			$attributes = array('id'=>'myform','name'=>'myform');
			echo form_open('admin/c_condi_menu/proaddata',$attributes); 
			?>
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0"  id="ListData">
              ...
              <tr>
                ...
                <td align="left">
                  <input name="trade_menu" type="text" id="trade_menu" style="width:350px;resize:none" placeholder="Nhập vào Tên Danh Mục" value="<?php echo set_value('trade_menu'); ?>" >
                  <input type="hidden" name="trade_type" id="trade_type" value="1" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td>Thứ tự</td>
                <td><input name="trade_order" type="text" id="trade_order" placeholder="Thứ tự hiển thị" style="width:50px;resize:none" value="1" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
