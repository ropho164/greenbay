          ...
          <div id="contentpage">            
            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0"  id="ListData">
              ...
              <tr>
                ...
                <td align="left"><input type="text" name="article_title_files_2" id="article_title_files_2" style="width:680px;resize:none" placeholder="Exp: SEE OUR FULL DRINK MENU..." value="<?php echo set_value('article_title_files_2'); ?>"/></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="left"><input type="text" name="article_files_2" id="article_files_2" style="width:680px;resize:none" placeholder="Exp: http://greenbayphuquocresort.com/uploads/file2.pdf" value="<?php echo set_value('article_files_2'); ?>"/></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="left"><input type="text" name="article_title_content_2" id="article_title_content_2" style="width:680px;resize:none" placeholder="Exp: BREAKFAST HOURS..." value="<?php echo set_value('article_title_content_2'); ?>"/></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="left"><textarea name="article_content_2" rows="8" id="article_content_2" style="width:680px;" placeholder=""><?php echo set_value('article_content_2'); ?></textarea></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="left"><input type="text" name="article_title_content_3" id="article_title_content_3" style="width:680px;resize:none" placeholder="Exp: FEATURED DISHES..." value="<?php echo set_value('article_title_content_3'); ?>"/></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="left"><textarea name="article_content_3" rows="8" id="article_content_3" style="width:680px;" placeholder=""><?php echo set_value('article_content_3'); ?></textarea></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		if($("#article_picture_2").val()!=''){
			...
			$("#completeUpload2").append('<a href="<?php echo base_url().'uploads/'?>'+$("#article_picture_2").val()+'" target="_blank"><img src="<?php echo base_url().'uploads/'?>'+$("#article_picture_2").val()+'" width="100"/></a>')
