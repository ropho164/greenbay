          ...
          <div id="contentpage">            
            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0"  id="ListData">
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td align="left"><input type="hidden" name="article_intro_type" id="article_intro_type" value="<?=$types?>" /><input type="hidden" name="article_parent" id="article_parent" value="7" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$('#userfile1').uploadFile({
			uploadStr:"Chọn hình",
			url:"<?php echo base_url(); ?>admin/uploadify/do_upload_abouts_480x316",
			fileName:"userfile",
			autoSubmit:true,
			returnType: "json",
			showPreview:false,
