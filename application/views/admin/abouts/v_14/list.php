            ...
            <form id="myform" name="myform" method="post">
              ...
              <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2" id="ListData">
                ...
                <tr <?php if(!($num%2)){echo 'class="bgcolor2"';}?>>
                  ...
                  <td align="left" nowrap="nowrap"><img src="<?php echo base_url();?>uploads/<?=$obj['article_picture_1']?>" height="90" border="0" style="border:1px #333333 solid;margin:5px 5px 5px 5px"  /></td>
                  <td align="left" valign="top"><div style="margin:5px 5px 5px 5px">
                    <div style="font-weight:bold;color:#454545;clear:both"><?php echo $obj['article_title_1'];?></div>
                    <div style="font-weight:bold;color:#454545;clear:both"><?php echo $obj['article_title'];?></div>
                  </div></td>
                  <td align="center" nowrap="nowrap"><input class="editorder" name="editorder" value="<?=$obj['article_order']?>" style="width:40px;text-align:center" data="<?=$obj['id']?>"/></td>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$( ".editorder" ).change(function() {
			...
			$.ajax({
				data:{id:id,article_order:order},
				url: '<?=base_url()?>admin/abouts/updOrder',
				type:"POST",
				dataType:"text",
