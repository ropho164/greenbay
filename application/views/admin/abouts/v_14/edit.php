          ...
          <div id="contentpage">            
            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0"  id="ListData">
              ...
              <tr>
                ...
                <td align="left"><input type="text" name="article_title_1" id="article_title_1" style="width:680px;resize:none" placeholder="Tiêu đề" value="<?=$results_data_edit[0]['article_title_1']?>"/></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td>Ghi chú<sup></sup></td>
                <td align="left"><input type="text" name="article_title" id="article_title" style="width:680px;resize:none" placeholder="Exp: 2 day 3 night" value="<?=$results_data_edit[0]['article_title']?>"/></td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td>
                <td width="200">&nbsp;</td>
              ...
              <tr>
                ...
                <td align="left">
                <textarea name="article_desc" rows="8" id="article_desc" style="width:680px;resize:none" placeholder="Mô tả"><?=$results_data_edit[0]['article_desc']?></textarea></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td nowrap="nowrap">&nbsp;</td>
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$('#userfile1').uploadFile({
			uploadStr:"Chọn hình",
			url:"<?php echo base_url(); ?>admin/uploadify/do_upload_abouts_800x430",
			fileName:"userfile",
			autoSubmit:true,
			returnType: "json",
			showPreview:false,
		...
		$('#userfile2').uploadFile({
			uploadStr:"Chọn hình",
			url:"<?php echo base_url(); ?>admin/uploadify/do_upload_abouts_533x400",
			fileName:"userfile",
			autoSubmit:true,
			returnType: "json",
			showPreview:false,
	...
	bkLib.onDomLoaded(function() {
		...
		edt.panelInstance('article_desc');
	});
</script>
