  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top">
          <div id="contentpage">            
            <div id="iTitle">Cập nhật E-brochure</div><br/>
            <?php 
                  ...
                  <div class="row" style="z-index: 0">
                    <div class="col-xs-6">
                      <div class="input-group">
                        <input name="article_files_1" id="article_files_1" type="text" class="form-control input-sm" placeholder="Vui lòng chọn file" readonly value="<?=$results_data_edit[0]['article_files_1']?>">
