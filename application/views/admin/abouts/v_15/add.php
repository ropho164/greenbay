          ...
          <div id="contentpage">            
            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0"  id="ListData">
              ...
              <tr>
                <td>&nbsp;</td>
                <td>Tagline</td>
                <td align="left"><input type="text" value="<?php echo set_value('article_title_content_1'); ?>" name="article_title_content_1" id="article_title_content_1" style="width:680px;resize:none" placeholder="NESTLED INTO NATURE"/></td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td>
                <td width="200">&nbsp;</td>
