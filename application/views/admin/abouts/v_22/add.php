          ...
          <div id="contentpage">            
            ...
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0"  id="ListData">
              ...
              <tr>
                <td>&nbsp;</td>
                <td>Tiêu đề</td>
                <td align="left"><input type="text" value="<?php echo set_value('article_title'); ?>" name="article_title" id="article_title" style="width:680px;resize:none" placeholder="Tiêu đề"/></td>
              </tr>
              <tr>
                <td width="20">&nbsp;</td>
                <td width="200">&nbsp;</td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td valign="top" nowrap="nowrap">Giới thiệu</td>
                <td align="left">
						...
						<div class="col-xs-6">
						  <div class="input-group">
							  ...
							  <span class="input-group-btn">
								<button id="elfinder_button" data-width="200" data-height="200" class="btn btn-sm" type="button">Files...</button>
							  </span>
						</div>
					  </div>
					</div>
              ...
              <tr>
                <td>&nbsp;</td>
                <td>Link liên kết</td>
                <td align="left"><input type="text" name="article_title_1" id="article_title_1" style="width:680px;resize:none" placeholder="Link đến bài viết" value="<?php echo set_value('article_title_1'); ?>"/></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
