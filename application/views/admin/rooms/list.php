...
$idgroup = ($this->uri->segment($this->config->item('uri_segment_fillter'))) ? $this->uri->segment($this->config->item('uri_segment_fillter')) : 0;
$CI =&get_instance();
?>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top">
          <div id="contentpage">            
            <div id="iTitle">Danh sách các bài viết</div>
            <form id="myform" name="myform" method="post">
              <div id="iMenuAction" style="clear:both">
                Có <strong><?=$count?></strong> dòng
                - <a href="<?php echo base_url()."admin/rooms/addata";?>" title="Add new data">Thêm dữ liệu</a> | <a href="javascript:void(0)" onclick="return DelMulti('<?php echo base_url()."admin/rooms/delmultirecord";?>')">Xóa dữ liệu chọn</a></div>
              ...
              <table width="90%" border="0" align="center" cellpadding="0" cellspacing="2" id="ListData">
                <tr>
                  ...
                  <th nowrap="nowrap" width="80">Thứ tự</th>
                  <th nowrap="nowrap" width="50">Hot</th>
                ...
                <tr <?php if(!($num%2)){echo 'class="bgcolor2"';}?>>
                  ...
                  <td align="left" nowrap="nowrap"><img src="<?php echo base_url();?>uploads/rooms/<?=$obj['article_picture_1']?>" width="100" border="0" style="border:1px #333333 solid;margin:5px 5px 5px 5px"  /></td>
                  <td align="left" valign="top"><div style="margin:5px 5px 5px 5px">
                  	<div style="font-weight:bold;color:#0f9e4a;clear:both"><?=$obj['article_price_apply']?></div>
                    <div style="font-weight:bold;color:#454545;clear:both"><?php echo word_limiter($obj['article_title'],30);?></div>
                    </div></td>
                  <td align="center" nowrap="nowrap">
                    <input class="editorder" name="editorder" value="<?=$obj['order_article']?>" style="width:40px;text-align:center" data="<?=$obj['id']?>"/>
                  </td>
                  <td align="center" nowrap="nowrap"><?php
                  	if($obj['article_hot']==1){
						echo '<img src="'.base_url().'templates/admin/images/ok.gif" border="0" title="hot" alt="hot"  />';
					}
					else{
						echo '<img src="'.base_url().'templates/admin/images/no.gif" border="0" title="no check hot" alt="no check hot"  />';
					}
				  ?></td>
                  <td align="center" nowrap="nowrap">
                    <?php
                  ...
                  <td align="center" valign="middle" nowrap="nowrap">
                   <a href="<?php echo base_url()."admin/rooms/editdata/".$obj['id'];?>"><img src="<?php echo base_url();?>templates/admin/images/b_edit.png" width="16" height="16" border="0" title="Chỉnh sửa thông tin dòng này" alt="Chỉnh sửa thông tin dòng này"  /></a>
                    &nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="return Del(<?=$obj['id']?>,'<?php echo base_url()."admin/rooms/delrecord";?>')"><img src="<?php echo base_url();?>templates/admin/images/b_drop.png" width="16" height="16" border="0" title="Xóa dòng này" alt="Xóa dòng này"  /></a>	
                     &nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="return DuplicateRow('id',<?=$obj['id']?>,'<?php echo base_url()."admin/rooms/duplicaterow";?>')"><img src="<?php echo base_url();?>templates/admin/images/import-icon.png" width="16" height="16" border="0" title="Copy dòng này" alt="Copy dòng này"  /></a>	
                    </td>
                  </tr>
                <?php }?>
                </table>
    ...
    $(document).ready(function () {
		$( ".editorder" ).change(function() {
			...
			$.ajax({
				...
				url: '<?=base_url()?>admin/rooms/updOrder',
				type:"POST",
				dataType:"text",
		...
		$( ".editview" ).change(function() {
			...
			$.ajax({
				...
				url: '<?=base_url()?>admin/rooms/updView',
				type:"POST",
				dataType:"text",
				success:function(data){
					if(data==1){
		...
		$("#article_langue").change(function () {			
	        window.location = "<?=base_url()?>admin/rooms/fillter/"+$(this).val();
		});
	});
</script>
