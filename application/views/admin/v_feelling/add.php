  ...
  <tr>
    <td>
      ...
      <tr>
        <td valign="top">
          <div id="contentpage">            
            <div id="iTitle">Thêm cảm nhận KH</div><br/>
            <?php 
			$attributes = array('id'=>'myform','name'=>'myform');
			echo form_open('admin/c_feelling/proaddata',$attributes); 
			?>
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0"  id="ListData">
              ...
              <tr>
                ...
                <td align="left">
                  <input name="title_feel" value="<?php echo set_value('title_feel'); ?>" type="text" id="title_feel" style="width:680px;resize:none" placeholder="Tiêu đề" ></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td>
                  Mô tả<sup>*</sup></td>
                <td>
                <textarea name="desc_feel" rows="8" id="desc_feel" style="width:680px;" placeholder="Giới thiệu sơ lược nội dung"><?php echo set_value('desc_feel'); ?></textarea>
                </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td>Link<sup>*</sup></td>
                <td align="left">
                <input name="link_feel" value="<?php echo set_value('link_feel'); ?>" type="text" id="link_feel" style="width:680px;resize:none" placeholder="Link liên kết" ></td>
                </td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td>Thứ tự</td>
                <td><input name="order_feel" type="text" id="order_feel" style="width:50px;resize:none" value="<?=$count+1?>" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td>Trạng thái</td>
                <td><input name="active_feel" type="checkbox" id="active_feel" value="1" <?php echo set_checkbox('active_feel', '1'); ?>/></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                <td>&nbsp;</td>
                <td>Ngày</td>
                <td><input type="text" id="date_feel" name="date_feel" readonly></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
