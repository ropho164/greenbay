  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top">
          <div id="contentpage">            
            <div id="iTitle">Cập nhật thông tin liên hệ website</div><br/>
            <?php 
			$attributes = array('id'=>'myform','name'=>'myform');
			echo form_open('admin/c_infocontact/proeditdata',$attributes); 
			?>
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0"  id="ListData">
              ...
              <tr>
                ...
                <td align="left"><input name="info_title" type="text" id="info_title" placeholder="Tiêu đề về Amarin Resort" style="width:690px;resize:none" value="<?php echo $results_data_edit[0]['info_title']; ?>" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="left"><textarea name="info_content" rows="5" id="info_content" style="width:700px;resize:none" placeholder="Thông tin về Amarin Resort"><?=$results_data_edit[0]['info_content']?></textarea><?php echo display_ckeditor($ckeditor); ?></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="left"><input name="info_title_office" type="text" id="info_title_office" placeholder="Tiêu đề cho văn phòng đại diện" style="width:690px;resize:none" value="<?=$results_data_edit[0]['info_title_office']?>" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="left"><textarea name="info_content_office" rows="5" id="info_content_office" style="width:700px;resize:none" placeholder="Thông tin văn phòng đại diện"><?=$results_data_edit[0]['info_content_office']?></textarea>
