  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td valign="top">
          <div id="contentpage">            
            <div id="iTitle">Thêm danh mục con</div><br/>
            <?php 
			$attributes = array('id'=>'myform','name'=>'myform');
			echo form_open('admin/sub_menu/proaddata',$attributes); 
			?>
            <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0"  id="ListData">
              ...
              <tr>
                ...
                <td align="left">
                  <input name="sub_name_en" type="text" id="sub_name_en" value="<?php echo set_value('sub_name_en'); ?>" style="width:350px;resize:none" placeholder="Nhập vào Tên Danh Mục Con Tiếng Anh" ></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td align="left">
                  <input name="sub_name_vn" type="text" id="sub_name_vn" value="<?php echo set_value('sub_name_vn'); ?>" style="width:350px;resize:none" placeholder="Nhập vào Tên Danh Mục Con Tiếng Việt" ></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td><input name="sub_order" type="text" id="sub_order" placeholder="Thứ tự menu" style="width:50px;resize:none" value="1" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
