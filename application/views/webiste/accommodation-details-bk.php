                ...
                <div class="content_about_detail">
                    ...
                    <div class="content_accom_detail">
                       ...
                       <?php if($results_photo_slide && sizeof($results_photo_slide)>0){?>
                        <div id="jssor_thumb" style="position: relative; top: 0px; left: 0px; width: 800px;height: 505px; ">
							<!-- Slides Container -->
							...
							<div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 800px; height: 356px;
								overflow: hidden;">
								<?php foreach($results_photo_slide as $objSlide){?>
								<div>
									<img data-u="image" src="<?php echo base_url().'uploads/rooms/slide_details/'.$objSlide['pro_photo']?>" />
									<img data-u="thumb" src="<?php echo base_url().'uploads/rooms/slide_details/'.$objSlide['pro_photo']?>">
								</div>
								<?php } ?>
							</div>
							<div data-u="thumbnavigator" class="jssort01" style="position:absolute;left:0px;bottom:0px;width:800px;height:200px;" data-autocenter="1">
						...
						<?php } else { ?>
							<img src="<?php echo base_url().'uploads/rooms/'.$obj['article_picture_1'];?>" class="img-responsive" />
						<?php } ?>
						<!-- Jssor Slider End -->
                    </div>
                    </div>
                </div>  
                <div class="leaf_bottom_one"><img src="images/left_abouts.png" alt="" class="img-responsive"></div>
            </div>
        </div>
