...
<div class="page_full">
    ...
    <?php include ("banner-slider-sub.php");?>
    <?php include ("quick-form-res.php");?>
    <div class="container-full clearfix" style="background-color: rgba(255,255,255,1.00)">
    	<?php if($results_wedding && sizeof($results_wedding)>0){
	   foreach($results_wedding as $obj){?>
       	<div id="weddings-conferences" class="about_parent_home clearfix">
                                ...
                                <div class="content_about_detail_desc_text font_std">
									...
									<div class="font_std">
										...
										<p class="text-center pdt10" style="line-height: 22px">
											<a href="<?=$obj['article_files_1']?>" class="font_bold_std" style="color:#00904c" target="_blank">
    ...
    <?php } } 
	if($results_event && sizeof($results_event)>0){
						...
						<div class="content_about_detail">
							<div class="content_about_detail_desc_text font_std pull-left">
								...
								<div class="font_std">
									...
									<p class="text-center pdt10" style="line-height: 22px">
										<a href="<?=$obj['article_files_1']?>" class="font_bold_std" style="color:#00904c" target="_blank"><?=$obj['article_title_files_1']?></a>
									</p>
								</div>
							</div>
						</div>
    ...
    <?php } }
	if($results_sports && sizeof($results_sports)>0){$cntSport = 0;?>
    <!--end-->
    <div id="sports-recreation-outlet" class="about_parent_home bg_things_to_see_photo item-affect clearfix" style="
	background-color: rgba(255,255,255,1.00);">
		<div class="col-xs-12 bg_pool_bar mg0 pd0">
			<div class="content_accom_detail">
				<div class="_title_special"><?=$results_sports[0]["article_title_1"]?></div>
				<div class="_title pdb15">
					<div class="_item_title">
						<div class="clearfix"><?=$results_sports[0]["article_title"]?></div>
						<div class="clearfix _item_underline_title"></div>
					</div>
				</div>
				<div class="pdt15 clearfix">
					<div id="jssor_thumb" style="position: relative; top: 0px; left: 0px; width: 900px;height: 540px;">
						<!-- Slides Container -->
						<div data-u="loading" style="position:absolute;top:0px;left:0px;background-color:rgba(0,0,0,0.5);">
							<div style="filter: alpha(opacity=70); opacity: 0.7; position: absolute; display: block; top: 0px; left: 0px; width: 100%; height: 100%;"></div>
							<div style="position:absolute;display:block;background:url('<?=base_url()?>templates/website/img/loading.gif') no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
						...
						<div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 900px; height: 500px;overflow: hidden;">
							<?php foreach($results_sports as $obj){?>
								<div>
								<img data-u="image" src="<?=base_url().'uploads/'.$obj['article_picture_1']?>" />
								<div class="caption" data-u="caption" id="caption-slide-<?=$cntSport?>">
									<div class="text-center pdt15 clearfix">
										<div class="_item_title">
										...
										<div class="pdt15 font_std text-left clearfix">
											<?=html_entity_decode($obj['article_content'])?>
										</div>
									</div>
								</div>
						...
						<div data-u="navigator" class="jssorb122">
							<div data-u="prototype"></div>
						</div>
						<!--#region Arrow Navigator Skin Begin -->
						<!-- Arrow Left -->
						<span u="arrowleft" class="jssora022l">
						</span>
						<!-- Arrow Right -->
						<span u="arrowright" class="jssora022r">
						</span>
					</div>
				</div>
				<div id="intro-slide" class="pdb25 clearfix">
				</div>
				<!-- Jssor Slider End -->
			</div>
		</div>
