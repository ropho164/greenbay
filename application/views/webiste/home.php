...
<div class="page_full">
    ...
    <div class="container-full clearfix">
                    ...
                    <div class="item-container-fluid">
                        <div class="item-row-fluid-bottom text-center">
                            ...
                            <div class="content_spa clearfix">
                                <a href="<?=base_url().$this->lang->line('key')?>/interests/sim-valley-spa">
		...
		if(isset($results_feel) && sizeof($results_feel)>0){
			echo '<div class="special_offer_parent_home pdt20 pdbt20 item-affect clearfix">';
			echo '<div id="carousel_feel" class="clearfix">';
			$cnt_feel = 0;
			foreach ($results_feel as $obj){
				$cnt_feel++;
				$pt = "";
				echo '<div class="_feel_item">';
					if($obj['article_picture_1']!="" && $obj['article_picture_1']!=null){
						$pt = "";
						echo '<img src="'.base_url().$obj['article_picture_1'].'" id="item-'.$cnt_feel.'" class="img-responsive center-block img-circle" />';
					}else{
						$pt = "pdt20";
					}
					echo '<div class="row parent_feel_talk '.$pt.'">';
						...
						echo '<div class="feel_talk_nesed">';
							...
							echo '<p class="text-right"><a class="color_brand_link small" href="'.$obj['article_title_1'].'" target="_blank"><em>'.$this->lang->line('more').'</em></a></p>';
						echo '</div>';
					echo '</div>';
				echo '</div>';
			}
			echo '</div>';
			echo '<div class="row carousel-arrows text-center pdbt15"></div>';
		}?>
	    </div>
...
<script src="<?=base_url()?>templates/website/js/jquery-1.9.1.min.js"></script>
<script src="<?=base_url()?>templates/website/js/jquery-ui.min.js"></script>
<script src="<?=base_url()?>templates/website/js/jquery.mobile.customized.min.js"></script>
