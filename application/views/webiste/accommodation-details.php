...
<div class="page_full">
    ...
    <div class="about_parent_home clearfix">
        ...
        <div class="row mgbt0 bg_top_details_room mg0 pd0 item-affect clearfix">
            <div class="col-xs-12 mg0 pd0">
                <div class="content_about_detail">
                    ...
                    <div class="content_accom_detail">
						  <div id="photoRoomsCarousel" class="carousel slide" data-ride="carousel">		
							<?php if(isset($results_photo_slide) && sizeof($results_photo_slide)>0){
								echo '<div class="carousel-inner" role="listbox">';
								$cnt_main = 0;
								$clAct = "";
								foreach($results_photo_slide as $objSlide){
									$clAct = "";
									$cnt_main++;
									if($cnt_main==1) $clAct = "active";					
									echo '<div class="item '.$clAct.'">';
										echo '<img src="'.base_url().'uploads/rooms/slide_details/'.$objSlide['pro_photo'].'" class="img-responsive center-block">';
									echo '</div>';

								}
								echo '</div>';
								echo '<a class="left carousel-control" href="#photoRoomsCarousel" data-slide="prev">';
									//echo '<span class="glyphicon glyphicon-chevron-left"></span>';
									echo '<img src="'.base_url().'templates/website/images/prev_co_black.png">';
									//echo '<span class="sr-only">Previous</span>';
								echo '</a>';
								echo '<a class="right carousel-control" href="#photoRoomsCarousel" data-slide="next">';
									//echo '<span class="glyphicon glyphicon-chevron-right"></span>';
									echo '<img src="'.base_url().'templates/website/images/next_co_black.png">';
									//echo '<span class="sr-only">Next</span>';
								echo '</a>';
							}else{
								echo '<div class="carousel-inner" role="listbox">';
									echo '<div class="item active">';
									echo '<img src="'.base_url().'uploads/rooms/'.$obj['article_picture_1'].'" class="img-responsive center-block" />';
									echo '</div>';
								echo '</div>';
							}?>
						</div>                       
        ...
        <div class="row mgbt0 mg0 pd0 item-affect clearfix" style="position: relative">
        	<div class="line_green_accom_details"></div>
           	<div class="col-xs-12 special_offer_parent_home mg0 pd0 pdt25 clearfix">
				<div class="content_accom_detail clearfix" style="padding-left:7px;padding-right:7px;padding-bottom: 15px">
               		<div class="col-xs-6 mg0 pd0">
               			<div class="font_std pdt15 pdb15">    
							<?=$obj["article_desc"]?>
						</div> 
                    ...
                    <div class="col-xs-6 mg0 pd0">
                    	<div class="line_green_yellow bg_radient_green_block clearfix">&nbsp;</div>
                         ...
                         <div class="row mg0 pd0 clearfix">
                             <div class="div_left clearfix">
                                 <div class="mg0 pd0 text-left" style="width:auto">
									 ...
									 <br/>
									 <span class="font_std txtt_trans_up" style="font-size:11pt">
										<?php if($language=='vn'){
            ...
            <div class="col-xs-12 bg_accom_other_room_end mg0 pd0 pdt25">
             <?php
                ...
                <div class="content_accom_detail mg0 pd0 clearfix">
                    <div class="row mg0 pd0 pdt25">
                            <div id="ortherRoomsCarousel" class="carousel slide" data-ride="carousel" data-interval="false">
                              <div class="carousel-inner">
                               <div class="row item active">
                                <?php
								  ...
								  ?>
                                  <div class="col-xs-6">
                                    <a href="<?php echo base_url().$language.'/'.$objOrther['category_lnk'].'/'.$objOrther['sub_lnk_'.$this->lang->line('key')];?>" class="portfolio-box galleryItem">
                                       <img src="<?php echo base_url().'uploads/rooms/'.$objOrther['article_picture_2'];?>" class="img-responsive center-block">
                                ...
                                <?php 
									  if($cntOrther==2 && sizeof($results_rooms_orther)>$cntFull){
										$cntOrther = 0;
							...
							<a class="left carousel-control" href="#ortherRoomsCarousel" data-slide="prev">
								<img src="<?=base_url()?>templates/website/images/prev_co_black.png">
							</a>
							<a class="right carousel-control" href="#ortherRoomsCarousel" data-slide="next">
								<img src="<?=base_url()?>templates/website/images/next_co_black.png">
							</a>
                            </div>
                     </div>
                </div>
