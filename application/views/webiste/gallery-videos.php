    	...
    	<div class="gallery_page_leaf_bottom_right">
    		...
    		<div class="spedoffer_page_leaf_blue">
				...
				<div class="header_special_offer item-affect clearfix">
   				...
   				<div class="gallery_page_content_bound item-affect clearfix">
					<div style="width: 230px;margin: 0 auto">
						<div class="col-xs-6">
							<a href="<?=base_url().$this->lang->line('key')?>/gallery" class="a_coolor">
				...
				<div class="gallery_page_content_bound_noline clearfix">
					  <?php if($results_video && sizeof($results_video)>0){
						foreach($results_video as $obj){?>
						  <div class="gallery_video_row item-affect clearfix">
							<div class="col-xs-12 mg0 pd0 text-center">
								<p class="font_bold_std"><?=$obj["title_video"]?></p>
								<div class="font_std">
									<?=html_entity_decode($obj["poster_video"])?>
								</div>
							</div>
							<div class="col-xs-12 mg0 pd0" style="margin-top: 25px">
								<div class="video-container"><?=html_entity_decode($obj["file_video"])?></div> 
							</div>    				  	
						  </div>
					  <?php } }?>				
				</div>
    			<!--
    			<div class="pdt15 text-center clearfix">
